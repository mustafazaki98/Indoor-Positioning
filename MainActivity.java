...
public class MainActivity extends AppCompatActivity implements SensorEventListener, TextToSpeech.OnInitListener {
    ...
    private String[] labels = {"Short Step", "Normal Step", "Long Step"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shortTextView = (TextView) findViewById(R.id.short_prob);
        normalTextView = (TextView) findViewById(R.id.normal_prob);
        longTextView = (TextView) findViewById(R.id.long_prob);
    ...
    private void activityPrediction() {
        if (x.size() == N_SAMPLES && y.size() == N_SAMPLES && z.size() == N_SAMPLES) {
            ...
            shortTextView.setText(Float.toString(round(results[0], 2)));
            normalTextView.setText(Float.toString(round(results[1], 2)));
            longTextView.setText(Float.toString(round(results[2], 2)));
